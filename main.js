...
const keys = [
  ...
  //nextOne.addEventListener("click", makeProgress);
  nextOne.onclick = progressToLineTwo;
  
  // Write anonymous event handler property and function for the second progress button
  const progressToLineThree = () => {
  ...
  nextTwo.onclick = progressToLineThree;
  
  // Write anonymous event handler property and function for the third progress button
  const progressToLineFour = () => {
  ...
  nextThree.onclick = progressToLineFour;
